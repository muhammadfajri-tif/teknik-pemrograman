...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (sc.hasNext()) {
            ...
            } else if (employeeType.equals("Freelancer")) {
                int taskFinished = sc.nextInt();
                int totalTask = sc.nextInt();
                
                Freelancer freelancer = new Freelancer(numberOfHoursWorked, hourlyRate, storeDetails, basePay,
                    empName,taskFinished, totalTask);
        ...
        System.out.println("******************************************************");
        System.out.println("Number of employees working as FREELANCER are: " + freelancerList.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as FREELANCER are: " + freelancerList.size());
        pwd.println("******************************************************");
        for (Freelancer freelancer : freelancerList) {
            freelancerCount++;
            System.out.println(freelancerCount + ". Freelancer Details:");
            System.out.println(freelancer);
            pwd.println(freelancer);
            System.out.println("Total commission: $" + freelancer.calculateCommission());
            System.out.println("Gross Payment: $" + freelancer.calculatePay());
            
            pwd.println("Total commission: $" + freelancer.calculateCommission());
            pwd.println("Gross Payment: $" + freelancer.calculatePay());
            System.out.print("Is " + freelancer.getEmployeeName() + " eligible for promotion? ");
            if (freelancer.checkPromotionEligibility()) {
