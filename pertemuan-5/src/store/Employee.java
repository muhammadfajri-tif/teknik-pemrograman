...
public interface Employee {
    ...
    /**
     * This method Checks if the employee has steady position in company or not.
     *
     * @return - This method returns boolean the employee steady position status.
     */
    boolean isSteadyPosition();
}
