...
public class Salesperson implements Comparable {
	...
	public int compareTo(Object other) {
		...
		// comparison should be based on total sales
		...
		if (this.totalSales < sales.totalSales) {
			...
			// return a positive number if the sales are greate
			result = 1;
		} else {
			// Use the name of the sales person to break a tie (alphabetical order)
